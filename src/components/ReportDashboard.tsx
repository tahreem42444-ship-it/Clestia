        ...
        <section className="pt-6 border-t border-border/20">
          <div className="glass rounded-2xl p-5 sm:p-6 text-center max-w-2xl mx-auto space-y-2.5 border border-border/40 bg-[oklch(1_0_0/0.01)]">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              ...
              data stays locally in this browser. You can save or print your report locally using
              the Export PDF utility. This is for self-reflection and entertainment, not
              professional advice.
            </p>
          </div>
        </section>
