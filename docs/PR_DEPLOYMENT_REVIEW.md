...
2. **One-Off Email Delivery:** The email option sends the _current_ horoscope report only. Periodic/scheduled subscription daily emails require a future backend implementation with cron-jobs, subscriber lists, and unsubscribe mechanisms.
